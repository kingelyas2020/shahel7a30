...
def ressture():
   ...
   import getpass
   sandi = raw_input('║PW      : ')
   if sandi == 'mohammad_hacker' and user == 'subscribe':
      print '║LOGIN SUKSES\n╚═══════\x1b[1;91m▶'
      sys.exit
   else:
      print 'Login GAGAL, mohammad sultani ADMIN'
      wa()
      ressture()
def tik():
    titik = [
...
def lodhirt():
    lodhirt = [
     'mohammad hacker', '      ', 'mohammad hacker', '      ', 'mohammad hacker', '      ', 'mohammad hacker', '      ', 'mohammad hacker', '      ', 'mohammad hacker', '      ', 'mohammad hacker', '      ', 'mohammad hacker', '      ', 'mohammad hacker', '      ', 'mohammad hacker', 'mohammad hacker', '      ', 'mohammad hacker', '      ', 'mohammad hacker', '      ', 'mohammad hacker', '      ', 'mohammad hacker', '      ', 'mohammad hacker', '      ', 'mohammad hacker', '      ', 'mohammad hacker', '      ', 'mohammad hacker', '      ', 'mohammad hacker\n']
    for o in lodhirt:
...
print '║\033[1;37m{\033[1;33m2\033[1;37m} \033[1;34mmohammad Author \033[0m(\033[1;32myoytube\033[1;37m)'
